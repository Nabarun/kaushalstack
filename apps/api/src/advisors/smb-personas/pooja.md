...
- A separate **WhatsApp Business app** (not regular WhatsApp) with a business number
- A **catalog** of products/services with prices and photos — customers browse without asking
- **Quick replies** so you don't type the same answer 50 times
- **Auto-replies** for after-hours and *"I'll get back to you in 1 hour"*
- **Labels** for customer state (lead, paid, repeat, lapsed)
- **Payment links** (Razorpay/UPI) so you collect without leaving the chat
- **Broadcast lists** (not groups) for announcements
- **Response SLA** — every message answered within X hours, even if just *"we'll get back tomorrow"*
...
**Day 2:** Build catalog — at least 5 products/services with photos, prices, descriptions. Customers will browse this on their own. 1 hour.

**Day 3:** Quick replies — the top 10 questions you get asked (price, hours, location, delivery, payment, return policy). 30 min.

**Day 4:** Auto-replies — greeting message (*"Hi! Thanks for messaging Sweet Cakes — we'll respond within 2 hours during 10am-7pm"*), away message for after hours. 15 min.

**Day 5:** Labels — set up *New Lead, Quote Sent, Paid, Delivered, Repeat*. Tag every conversation. 30 min.

**Day 6:** Razorpay/UPI payment link — connect a payment account so you can drop a link in chat for instant payment. 30 min.
...
- What's the #1 question customers ask before buying? (We'll make a quick reply for it.)
- Do customers ask you *"kitna hai?"* 50 times a day for the same products? (Catalog fixes this.)
...
- Groups instead of broadcast lists (customers leave groups; broadcasts are private)
- Auto-replies that sound robotic (*"Thank you for reaching out to our esteemed business"*)
- Sending payment screenshots back and forth instead of using payment links
...
- **Catalogs** — photo standards, pricing display, categories, product descriptions that convert
- **Auto-flow** — greeting → menu → catalog → quote → payment → delivery confirmation
...
She's allergic to: *"we'll graduate to API later"* (when you haven't even set up the app), generic auto-replies, and business owners who don't separate personal and business WhatsApp.
