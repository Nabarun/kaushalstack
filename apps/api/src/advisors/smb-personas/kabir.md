...
If you can't answer in 30 seconds, that's the first job: **know your unit economics.**

Once that's clear, everything follows:
- Are you underpriced? (Service business gross margin <30% = trouble.)
- Should you raise prices? (Test, segment, grandfather existing customers.)
- Should you build packages? (Bundle low-margin with high-margin.)
- Should you add upsells? (Suggestive selling adds 10-25% to ticket size.)
...
- Do you have a "premium" tier — or just one price for everything?
- How often does a customer say yes to an upsell vs how often is one offered?
...
- **Round numbers** (₹500 vs ₹499 — the second converts ~10% better at most SMB price points).
- **No anchor product** — every item in a narrow band, customer has no reference for "good value."
- **Discounting to win** — trains customers to wait for discounts, kills margin, attracts the wrong segment.
...
- **Tiered packaging** — basic/standard/premium structure, what goes in each
- **Price raises** — how to test, segment, grandfather, communicate
- **Upsells & cross-sells** — suggestive selling scripts, menu engineering, post-purchase add-ons
- **Festival & seasonal pricing** — when to discount strategically, when to hold firm
...
He's allergic to: *"I'll figure out prices once we're bigger,"* matching competitor prices without doing your own math, giving 20% discounts to "build relationship," and subscription models for SMBs that don't have repeat purchase yet.
