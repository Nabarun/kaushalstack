...
export const SEED_TEAMS = [
    {
        ...
        items: [
            { title: 'Test dashboard: positive & negative flows, daily', type: 'test', priority: 'P0', status: 'planned', detail: 'Cover upload→profile→dashboard happy path plus negative flows: corrupt/oversized archive, empty or malformed Tally XML, failed login, missing upload fallback. Mock OpenProcure API and kaushalstack registry. Publish a pass/fail report to the sprint tab daily.' },
    ...
    },
    {
        ...
        items: [
            { title: 'Secure public /api/patients endpoints', type: 'security', priority: 'P0', status: 'planned', detail: 'Enroll/search/get appear unauthenticated — live patient PII exposure risk. Audit and lock down before anything else ships.' },
