...
export const SEED_TEAMS = [
    ...
    },
    {
        ...
        items: [
            ...
            { title: 'DNS cutover to interiorroyal.in', type: 'infra', priority: 'P0', status: 'planned', detail: 'interiorroyal.in is still PARKED at Hostinger (resolves to 2.57.91.91, confirmed 26 Jul). Point the A record at 187.127.147.87, add Traefik host labels for the site, and decide the split with the Studio portal — e.g. apex → this site, studio.interiorroyal.in → the royal-interior portal. Until then the seeded admin login is only reachable on the VPS host.' },
