...
export default function PublicMarketplacePage() {
  return (
    <div className="ks-marketplace overflow-hidden bg-white text-slate-950">
      <Helmet>
      ...
      <section className="relative isolate min-h-[690px] overflow-hidden bg-[#071b3a] text-white">
        <div className="absolute inset-0 opacity-70 [background-image:radial-gradient(circle_at_16%_18%,rgba(59,130,246,.32),transparent_29%),radial-gradient(circle_at_78%_63%,rgba(34,211,238,.22),transparent_28%),linear-gradient(rgba(255,255,255,.035)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.035)_1px,transparent_1px)] [background-size:auto,auto,56px_56px,56px_56px]" />
        <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#071b3a] to-transparent" />
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-5 pb-20 pt-20 sm:px-8 lg:min-h-[690px] lg:grid-cols-[1.03fr_.97fr] lg:px-10 lg:py-24">
          <div className="max-w-2xl">
            <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/[.07] px-3.5 py-2 text-xs font-semibold tracking-[.13em] text-blue-200 uppercase backdrop-blur"><Sparkles className="h-3.5 w-3.5" /> An AI operating layer for business</div>
            <h1 className="max-w-xl text-5xl font-semibold leading-[.96] tracking-[-.065em] sm:text-6xl lg:text-7xl">Make your business <span className="bg-gradient-to-r from-blue-200 via-sky-300 to-cyan-200 bg-clip-text text-transparent">move as one.</span></h1>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <Link to="/contact" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-blue-500 px-5 text-sm font-bold text-white transition hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-200">Design your stack <ArrowRight className="h-4 w-4" /></Link>
            ...
            <div className="mt-12 flex flex-wrap gap-x-7 gap-y-3 text-sm text-slate-300">
              {['Built around your workflow', 'Human control at every stage', 'Start focused. Expand when ready.'].map(item => <span key={item} className="flex items-center gap-2"><Check className="h-4 w-4 text-blue-200" /> {item}</span>)}
            </div>
          </div>
          <div className="relative mx-auto aspect-square w-full max-w-[560px]">
            ...
            <div className="absolute left-0 top-[19%] rounded-xl border border-white/10 bg-[#0f2a52]/85 px-3 py-2 text-xs shadow-2xl backdrop-blur-sm"><span className="block font-semibold text-blue-200">Research → decision</span><span className="text-slate-400">shared context</span></div>
