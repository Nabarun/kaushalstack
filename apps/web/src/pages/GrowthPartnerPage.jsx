                ...
                <div className="max-w-5xl mx-auto px-4 py-16">
                    ...
                    <div className="grid md:grid-cols-3 gap-4 mt-12">
                        ...
                        <Card>
                            ...
                            <CardContent className="text-sm text-muted-foreground">Each day at your chosen hour, the team scans the last 7 days of competitor activity and ships you findings + recommendations.</CardContent>
                        </Card>
                    </div>
                </div>
            </>
